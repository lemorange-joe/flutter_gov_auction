...
<body>
  ...
  <script>
    ...
    function ConfirmPush() {
      ...
      var pushData = {
        "title_en": document.getElementById("tbTitleEn").value,
        "body_en": document.getElementById("txtBodyEn").value,
        "title_tc": document.getElementById("tbTitleTc").value,
        "body_tc": document.getElementById("txtBodyTc").value,
        "title_sc": document.getElementById("tbTitleSc").value,
        "body_sc": document.getElementById("txtBodySc").value
      }
